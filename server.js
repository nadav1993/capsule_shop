...
try {
	mongoose.connect('mongodb://127.0.0.1:27017/CapsuleShop').then(() => {
		...
		require(path.resolve('server/models/capsule.model.server'));
		require(path.resolve('server/models/capsule.company.model.server'));
